...
SCHOOL_NAME, TAG = "东南大学", "SEU"
ENTRY_URL = "https://seu.91job.org.cn/sub-station/campus?xxdm=10286"
...
def collect(start: datetime, end: datetime, filters: dict[str, str], raw_dir: Path) -> list[dict[str, str]]:
    ...
    with HttpClient() as client:
        try:
            ...
            raise RuntimeError("东南大学当前网络出口被 91job 创宇盾规则 80001 拦截（HTTP 403）") from exc
    ...
    raise RuntimeError("东南大学当前只取得 SPA 外壳，静态资源随后仍被 WAF 拦截，无法稳定探索业务请求")
